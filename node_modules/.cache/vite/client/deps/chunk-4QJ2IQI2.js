...
import {
  __superGet
} from "./chunk-3DLX2WND.js";

// node_modules/vidstack/dev/chunks/vidstack-CtPKKudm.js
var SignalDirective = class extends AsyncDirective {
  ...
  _onValueChange() {
    ...
    {
      try {
        this._setValue((_a2 = this._signal) == null ? void 0 : _a2.call(this));
      } catch (error) {
...
// node_modules/vidstack/dev/chunks/vidstack-DgzeXCBq.js
      ...
      for (const type of keysOf(FONT_SIGNALS)) {
        ...
        effect(() => {
          ...
          for (const player2 of players) {
            (_a2 = player2.el) == null ? void 0 : _a2.style.setProperty(varName, varValue);
          }
...
function getCssVarValue(player, type, value) {
  ...
  switch (type) {
    case "fontFamily":
      ...
      (_a2 = player.el) == null ? void 0 : _a2.style.setProperty("--media-user-font-variant", fontVariant);
...
// node_modules/vidstack/dev/chunks/vidstack-Om1-cFPX.js
...
var _DefaultLayout = class _DefaultLayout extends Component {
  constructor() {
    super(...arguments);
    this._when = computed(() => {
...
_DefaultLayout.props = defaultLayoutProps;
...
function i18n(translations, word) {
  var _a2;
  return ((_a2 = translations()) == null ? void 0 : _a2[word]) ?? word;
}
...
function DefaultChaptersMenu({
  ...
  const { textTracks } = useMediaContext(), { viewType, clipStartTime, clipEndTime } = useMediaState(), {
    ...
    const cues = (_a2 = $track()) == null ? void 0 : _a2.cues.filter(
      (cue) => cue.startTime <= $endTime && cue.endTime >= $startTime
    );
    return !(cues == null ? void 0 : cues.length);
  });
  if ($disabled())
    return null;
...
function DefaultFontSetting({ label, option, type }) {
  ...
  const radioOptions = createRadioOptions(option.values), $hint = () => {
    var _a2;
    const value = $currentValue(), label2 = ((_a2 = radioOptions.find((radio) => radio.value === value)) == null ? void 0 : _a2.label) || "";
...
function DefaultMenuCheckbox({
  ...
  function onPress(event) {
    if ((event == null ? void 0 : event.button) === 1)
      return;
...
function DefaultQualityMenuSection() {
  return $signal(() => {
    ...
    return DefaultMenuSection({
      ...
      value: $signal(() => {
        var _a2, _b;
        const height = (_a2 = quality()) == null ? void 0 : _a2.height, bitrate = !hideQualityBitrate() ? (_b = quality()) == null ? void 0 : _b.bitrate : null, bitrateText = bitrate && bitrate > 0 ? `${(bitrate / 1e6).toFixed(2)} Mbps` : null, autoText = i18n(translations, "Auto");
...
var DefaultLayoutIconsLoader = class extends LayoutIconsLoader {
  async _load() {
    const paths = (await import("./vidstack-CRlTZX3Z-KE3CMJNE.js")).icons, icons = {};
...
// node_modules/vidstack/dev/define/vidstack-audio-layout-el.js
var _a;
var DefaultAudioLayout$1 = (_a = class extends DefaultLayout {
}, _a.props = {
  ...__superGet(_a, _a, "props"),
  ...
  return $signal(() => {
    ...
    effect(() => {
      ...
      if ($isTransitionActive() && document.activeElement === document.body) {
        (_a2 = media.player.el) == null ? void 0 : _a2.focus();
      }
    });
    function onResize() {
...
var _MediaAudioLayoutElement = class _MediaAudioLayoutElement extends Host(LitElement, DefaultAudioLayout$1) {
  constructor() {
    super(...arguments);
...
_MediaAudioLayoutElement.tagName = "media-audio-layout";
_MediaAudioLayoutElement.attrs = {
  smallWhen: {
    converter(value) {
...
var MediaAudioLayoutElement = _MediaAudioLayoutElement;

// node_modules/vidstack/dev/define/vidstack-video-layout-el.js
var _DefaultVideoLayout = class _DefaultVideoLayout extends DefaultLayout {
};
...
function DefaultKeyboardDisplay() {
  return $signal(() => {
    ...
    const $actionDataAttr = computed(() => {
      var _a2;
      const action = (_a2 = lastKeyboardAction()) == null ? void 0 : _a2.action;
...
function getText() {
  var _a2;
  const { $state } = useMediaContext(), action = (_a2 = $state.lastKeyboardAction()) == null ? void 0 : _a2.action, audioGain = $state.audioGain() ?? 1;
  switch (action) {
    case "toggleMuted":
...
function getIconName() {
  var _a2;
  const { $state } = useMediaContext(), action = (_a2 = $state.lastKeyboardAction()) == null ? void 0 : _a2.action;
  switch (action) {
    case "togglePaused":
...
var _MediaVideoLayoutElement = class _MediaVideoLayoutElement extends Host(LitElement, DefaultVideoLayout) {
  onSetup() {
    this.forwardKeepAlive = false;
    this._media = useMediaContext();
...
_MediaVideoLayoutElement.tagName = "media-video-layout";
_MediaVideoLayoutElement.attrs = {
  smallWhen: {
    converter(value) {
      return value !== "never" && !!value;
    }
...
var MediaVideoLayoutElement = _MediaVideoLayoutElement;

// node_modules/vidstack/dev/define/plyr-layout-el.js
var PlyrLayoutIconsLoader = class extends LayoutIconsLoader {
  async _load() {
    const paths = (await import("./vidstack-DXxIKXmd-P3WEQ7V2.js")).icons, icons = {};
    for (const iconName of Object.keys(paths)) {
      icons[iconName] = Icon({
        name: iconName,
...
function TimeSlider() {
  ...
  function Markers() {
    ...
    if (!Number.isFinite(endTime))
      return null;
    return (_a2 = markers()) == null ? void 0 : _a2.map(
      (marker) => html`
        <span
...
function Captions() {
  const media = useMediaContext(), activeCue = signal(void 0), $cueText = $signal(() => {
    var _a2;
    return unsafeHTML((_a2 = activeCue()) == null ? void 0 : _a2.text);
  });
  effect(() => {
...
var _MediaPlyrLayoutElement = class _MediaPlyrLayoutElement extends Host(LitElement, PlyrLayout) {
  onSetup() {
    this.forwardKeepAlive = false;
    this._media = useMediaContext();
  }
  onConnect() {
    var _a2;
    (_a2 = this._media.player.el) == null ? void 0 : _a2.setAttribute("data-layout", "plyr");
    onDispose(() => {
      var _a3;
      return (_a3 = this._media.player.el) == null ? void 0 : _a3.removeAttribute("data-layout");
    });
...
var MediaPlyrLayoutElement = _MediaPlyrLayoutElement;
...
//# sourceMappingURL=chunk-4QJ2IQI2.js.map
