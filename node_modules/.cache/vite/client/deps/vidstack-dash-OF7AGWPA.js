import {
  VideoProvider
} from "./chunk-S5QP6AWE.js";
import "./chunk-G5MG6NXF.js";
import {
  RAFLoop
} from "./chunk-LHU2AYOZ.js";
import {
  coerceToError
} from "./chunk-63DMN5IG.js";
import "./chunk-BWLH4CFC.js";
import {
  QualitySymbol
...
var DASHController = class {
  ...
  _dispatchDASHEvent(event) {
    var _a;
    (_a = this._ctx.player) == null ? void 0 : _a.dispatch(this._createDOMEvent(event));
  }
  _onTextFragmentLoaded(event) {
    var _a;
    const native = (_a = this._currentTrack) == null ? void 0 : _a[TextTrackSymbol._native], cues = (native == null ? void 0 : native.track).cues;
    if (!native || !cues)
      return;
  ...
  _onError(event) {
    ...
    {
      (_a = this._ctx.logger) == null ? void 0 : _a.errorGroup(`[vidstack] DASH error \`${data.message}\``).labelledLog("Media Element", this._video).labelledLog("DASH Instance", this._instance).labelledLog("Event Type", eventType).labelledLog("Data", data).labelledLog("Src", peek(this._ctx.$state.source)).labelledLog("Media Store", { ...this._ctx.$state }).dispatch();
    }
    switch (data.code) {
      case 27:
  ...
  _onNetworkError(error) {
    var _a;
    this._clearRetryTimer();
    (_a = this._instance) == null ? void 0 : _a.play();
  ...
  _enableAutoQuality() {
    ...
    (_a = this._instance) == null ? void 0 : _a.setQualityFor("video", qualities.selectedIndex, true);
  }
  _switchAutoBitrate(type, auto) {
    var _a;
    (_a = this._instance) == null ? void 0 : _a.updateSettings({
  ...
  loadSource(src) {
    ...
    if (!isString(src.src))
      return;
    (_a = this._instance) == null ? void 0 : _a.attachSource(src.src);
  }
  destroy() {
    var _a, _b, _c, _d;
    this._reset();
    ...
    this._stopLiveSync = null;
    (_d = (_c = this._ctx) == null ? void 0 : _c.logger) == null ? void 0 : _d.info("🏗️ Destroyed DASH instance");
  }
};
var DASHLibLoader = class {
  ...
  async _startLoading() {
    var _a, _b;
    (_a = this._ctx.logger) == null ? void 0 : _a.info("🏗️ Loading DASH Library");
    const callbacks = {
  ...
  _onLoadStart() {
    var _a;
    {
      (_a = this._ctx.logger) == null ? void 0 : _a.infoGroup("Starting to load `dash.js`").labelledLog("URL", this._lib).dispatch();
    }
  ...
  _onLoaded(ctor) {
    var _a;
    {
      (_a = this._ctx.logger) == null ? void 0 : _a.infoGroup("Loaded `dash.js`").labelledLog("Library", this._lib).labelledLog("Constructor", ctor).dispatch();
    }
  ...
  _onLoadError(e) {
    ...
    {
      (_a = this._ctx.logger) == null ? void 0 : _a.errorGroup("[vidstack] Failed to load `dash.js`").labelledLog("Library", this._lib).labelledLog("Error", e).dispatch();
    }
    this._ctx.player.dispatch(
...
var _DASHProvider = class _DASHProvider extends VideoProvider {
  constructor() {
    super(...arguments);
...
_DASHProvider.supported = isDASHSupported();
var DASHProvider = _DASHProvider;
export {
  DASHProvider
};
//# sourceMappingURL=vidstack-dash-OF7AGWPA.js.map
