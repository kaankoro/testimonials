...
var GoogleCastProvider = class {
  ...
  _resumeSession() {
    ...
    this.setCurrentTime(Math.max(this._player.currentTime, (localState == null ? void 0 : localState.currentTime) ?? 0));
    this.setMuted(muted());
  ...
  _buildLoadRequest(src) {
    ...
    request.autoplay = (((_a = this._reloadInfo) == null ? void 0 : _a.paused) ?? (savedState == null ? void 0 : savedState.paused)) === false;
    request.currentTime = ((_b = this._reloadInfo) == null ? void 0 : _b.time) ?? (savedState == null ? void 0 : savedState.currentTime) ?? 0;
    return request;
  }
...
//# sourceMappingURL=vidstack-google-cast-QEFJC7JH.js.map
