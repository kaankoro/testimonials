...
var AudioGain = class {
  ...
  get currentGain() {
    var _a, _b;
    return ((_b = (_a = this._gainNode) == null ? void 0 : _a.gain) == null ? void 0 : _b.value) ?? null;
  }
  get supported() {
    return true;
  }
...
var NativeAudioTracks = class {
  ...
  _onAddNativeTrack(event2) {
    ...
    this._ctx.audioTracks[ListSymbol._add](audioTrack, event2);
    if (_track.enabled)
      audioTrack.selected = true;
  }
  _onRemoveNativeTrack(event2) {
    const track = this._ctx.audioTracks.getById(event2.track.id);
    if (track)
      this._ctx.audioTracks[ListSymbol._remove](track, event2);
  }
  _onChangeNativeTrack(event2) {
    ...
    if (track)
      this._ctx.audioTracks[ListSymbol._select](track, true, event2);
  }
...
var HTMLMediaProvider = class {
  ...
  _removeSource() {
    var _a;
    (_a = this._media.querySelector("source[data-vds]")) == null ? void 0 : _a.remove();
  }
...
// node_modules/vidstack/dev/chunks/vidstack-YtBO8bQN.js
var HTMLRemotePlaybackAdapter = class {
  ...
  _setup() {
    var _a;
    if (!((_a = this._media) == null ? void 0 : _a.remote) || !this._canPrompt)
      return;
  ...
  _onStateChange(event2) {
    const state = this._media.remote.state;
    if (state === this._state)
      return;
    const detail = { type: this._type, state };
    this._ctx.delegate._notify("remote-playback-change", detail, event2);
    this._state = state;
  }
};
...
//# sourceMappingURL=chunk-G5MG6NXF.js.map
