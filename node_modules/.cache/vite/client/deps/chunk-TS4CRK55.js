...
// node_modules/vidstack/dev/chunks/vidstack-Bnoxq110.js
...
var TextTrack = class extends EventsTarget {
  ...
  addCue(cue, trigger) {
    ...
    if (!(cue instanceof TextTrackCue)) {
      (_a2 = this[TextTrackSymbol._native]) == null ? void 0 : _a2.track.addCue(cue);
    }
  ...
  removeCue(cue, trigger) {
    ...
    if (index >= 0) {
      ...
      (_a2 = this[TextTrackSymbol._native]) == null ? void 0 : _a2.track.removeCue(cue);
  ...
  setMode(mode, trigger) {
    ...
    (_a2 = this[TextTrackSymbol._onModeChange]) == null ? void 0 : _a2.call(this);
  }
  /** @internal */
  ...
  _parseContent(init) {
    import("./dev-SBLSTL53.js").then(({ parseText, VTTCue, VTTRegion }) => {
  ...
  async _load() {
    ...
    try {
      const { parseResponse, VTTCue, VTTRegion } = await import("./dev-SBLSTL53.js"), crossOrigin = (_a2 = this[TextTrackSymbol._crossOrigin]) == null ? void 0 : _a2.call(this);
...
//# sourceMappingURL=chunk-TS4CRK55.js.map
