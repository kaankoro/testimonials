import { H as Host, g as effect, s as setAttribute, q as computed } from './vidstack-Uw94Yvrg.js';
import { c as MediaProvider, d as MediaPlayer } from './vidstack-CpPO9Fgt.js';
...
class MediaProviderElement extends Host(HTMLElement, MediaProvider) {
  ...
  kn() {
    ...
    import('./vidstack-CSNoShp-.js').then(({ insertContent }) => {
