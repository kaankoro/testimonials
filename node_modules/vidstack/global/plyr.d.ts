...
declare class Plyr implements PlyrProps, PlyrMethods {
    ...
    loop: boolean;
    poster: string;
    get type(): "google-cast" | "" | "audio" | "video" | "youtube" | "vimeo" | "dash" | "hls";
    get isHTML5(): boolean;
    get isEmbed(): boolean;
    get buffered(): number;
    get stopped(): boolean;
